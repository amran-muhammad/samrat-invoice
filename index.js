...
(function (document) {
  ...
  // Select the HTML element where you want to display the date
...
function downloadPDF() {
  ...
  let invoice_number = getInvoiceNumber();
...
let invoice = document.getElementById('invoice').innerText = getInvoiceNumber()
function getInvoiceNumber() {
  let invoice_number = 1
  if (window.localStorage.getItem('invoice_number')) {
    invoice_number = window.localStorage.getItem('invoice_number')
  }
